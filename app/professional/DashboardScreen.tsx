        ...
        <>
          <View style={styles.overviewContainer}>
            ...
            <View style={styles.overviewCard}>
              ...
              >
                <FontAwesome5 name="tasks" size={24} color="#ff7f50" style={styles.icon} />
                <Text style={styles.overviewLabel}>Tasks ({tasks.length})</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.overviewItem}>
                <FontAwesome name="money" size={24} color="#4CAF50" style={styles.icon} />
                <Text style={styles.overviewLabel}>Income</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.overviewItem}>
                <AntDesign name="calendar" size={24} color="#f44336" style={styles.icon} />
