...
const ScheduleScreen: React.FC = () => {
  ...
  const [currentPicker, setCurrentPicker] = useState<'date' | 'start' | 'end'>('date');
  ...
  const handleConfirm = (event: any, selectedDate: Date | undefined) => {
    ...
    if (selectedDate) {
      if (currentPicker === 'date') {
        ...
        setNewSlotDate(moment(selectedDate).format('YYYY-MM-DD'));
      } else if (currentPicker === 'start') {
        setSelectedStartTime(selectedDate);
        setNewSlotStartTime(moment(selectedDate).format('HH:mm'));
      } else if (currentPicker === 'end') {
        setSelectedEndTime(selectedDate);
        setNewSlotEndTime(moment(selectedDate).format('HH:mm'));
      }
    }
  };
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            {Platform.OS !== 'web' && isDatePickerVisible && (
              <DateTimePicker
                value={selectedDateState || new Date()}
                mode={datePickerMode}
                display="default"
            ...
            {Platform.OS !== 'web' && isStartTimePickerVisible && (
              <DateTimePicker
            ...
            {Platform.OS !== 'web' && isEndTimePickerVisible && (
              <DateTimePicker
