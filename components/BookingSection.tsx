...
import { Button, Portal, Dialog, Paragraph, Modal, Provider as PaperProvider } from 'react-native-paper';
      ...
      <View style={styles.container}>
        ...
        <Portal>
          <Dialog visible={showAlert} onDismiss={() => setShowAlert(false)}>
            <Dialog.Title>{alertType === 'success' ? 'Success' : 'Error'}</Dialog.Title>
            <Dialog.Content>
